...
var isInAdPlayback = function isInAdPlayback(p) {
  return !!p.ads && typeof p.ads === 'object' && AD_STATES.indexOf(p.ads.state) > -1;
};
...
var perSourceBehaviors = function perSourceBehaviors() {
  ...
  this.on(CHANGE_DETECT_EVENTS, function (e) {
    ...
    // Bail-out conditions.
    if (_this2.perSourceBehaviors.disabled() || srcChangeTimer || isInAdPlayback(_this2)) {
      return;
    }
...
perSourceBehaviors.VERSION = '1.1.0';
